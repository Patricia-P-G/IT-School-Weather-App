function getDayOfTheWeek(utcDate) {
  // Pentru a crea o data dinr-o valoarea utc trebuie sa o inmultim cu 1000
  ...
  switch (dayIndex) {
    ...
    default:
      // Afisam o erpare daca index-ul nu este valid (nu ar trebui sa se ajung aici deoarece OpenWeather intoarce zilele saptamanii corect)
